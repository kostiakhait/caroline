...
/// <summary>
/// Creates the Desktop .lnk shortcut pointing at AppPaths.ClientExe
/// (IShellLink/IPersistFile COM interop). Ported from AppleKeyInstaller.
/// </summary>
internal static class ShortcutManager
{
    private const string ShortcutName = "Caroline.lnk";
    private const string Description = "Caroline";
